...
import { ProjectBatch } from "./batch";
import { ProjectHttpClient } from "./net/projecthttpclient";
import { toAbsoluteUrl } from "./utils/toabsoluteurl";
import { metadata } from "./utils/metadata";

export interface ProjectQueryableConstructor<T> {
    new(baseUrl: string | ProjectQueryable, path?: string): T;
}

/**
 * ProjectQueryable Base Class
 *
 */
export class ProjectQueryable<GetType = any> extends ODataQueryable<ProjectBatch, GetType> {

    protected _forceCaching: boolean;

    /**
     * Creates a new instance of the ProjectQueryable class
     *
     * @constructor
     * @param baseUrl A string or ProjectQueryable that should form the base part of the url
     *
     */
    constructor(baseUrl: string | ProjectQueryable, path?: string) {
        super();
     ...
     *
     * @param factory constructor for the new ProjectQueryable
     */
    public as<T>(factory: ProjectQueryableConstructor<T>): T {
     ...
     */
    protected getParent<T extends ProjectQueryable>(
        factory: ProjectQueryableConstructor<T>,
        baseUrl: string | ProjectQueryable = this.parentUrl,
        path?: string,
        batch?: ProjectBatch): T {
    ...
    /**
     * Clones this ProjectQueryable into a new ProjectQueryable instance of T
     * @param factory Constructor used to create the new instance
     * @param additionalPath Any additional path to include in the clone
     * @param includeBatch If true this instance's batch will be added to the cloned instance
     */
    protected clone<T extends ProjectQueryable>(factory: ProjectQueryableConstructor<T>, additionalPath?: string, includeBatch = true): T {
    ...
    protected toRequestContext<T>(
        ...
        return toAbsoluteUrl(this.toUrlAndQuery()).then(url => {
            ...
            const context: RequestContext<T> = {
                ...
                clientFactory: () => new ProjectHttpClient(),
 ...
 *
 */
export class ProjectQueryableCollection<GetType = any[]> extends ProjectQueryable<GetType> {
...
/**
 * Decorator used to specify the default path for ProjectQueryable objects
 * 
 * @param path 
 */
